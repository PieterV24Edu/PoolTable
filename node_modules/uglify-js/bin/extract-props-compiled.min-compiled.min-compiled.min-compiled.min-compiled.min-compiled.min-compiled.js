...
"use strict";
var U2 = require("../tools/node");var fs = require("fs");var yargs = require("yargs");var ARGS = yargs.describe("o", "Output file").argv;var files = ARGS._.slice();var output = { vars: {}, props: {} };if (ARGS.o) try {
  output = JSON.parse(fs.readFileSync(ARGS.o, "utf8"));
} catch (ex) {}files.forEach(getProps);if (ARGS.o) {
  ...
  var code = fs.readFileSync(filename, "utf8");var ast = U2.parse(code);ast.walk(new U2.TreeWalker(function (node) {
...
//# sourceMappingURL=extract-props-compiled.min-compiled.min-compiled.min-compiled.min-compiled.min-compiled.min-compiled.js.map