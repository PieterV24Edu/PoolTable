    ...
    node.DEFMETHOD("transform", function (tw, in_list) {
      var x, y;tw.push(this);if (tw.before) x = tw.before(this, descend, in_list);if (x === undefined) {
        if (!tw.after) {
          ...
          tw.stack[tw.stack.length - 1] = x = this;descend(x, tw);y = tw.after(x, in_list);if (y !== undefined) x = y;
        }
      }tw.pop(this);return x;
    });
...
//# sourceMappingURL=transform-compiled.min-compiled.min-compiled.min-compiled.min-compiled.min-compiled.js.map