...
describe('cliui', function () {
  describe('div', function () {
    ...
    it('evenly divides text across columns if multiple columns are given', function () {
      ...
      ui.div({ text: 'i am a string that should be wrapped', width: 15 }, 'i am a second string that should be wrapped', 'i am a third string that should be wrapped');
  ...
  describe('alignment', function () {
    it('allows a column to be right aligned', function () {
      ...
      ui.div('i am a string', { text: 'i am a second string', align: 'right' }, 'i am a third string that should be wrapped');
    ...
    it('allows a column to be center aligned', function () {
      ...
      ui.div('i am a string', { text: 'i am a second string', align: 'center', padding: [0, 2, 0, 2] }, 'i am a third string that should be wrapped');
  ...
  describe('padding', function () {
    it('handles left/right padding', function () {
      ...
      ui.div({ text: 'i have padding on my left', padding: [0, 0, 0, 4] }, { text: 'i have padding on my right', padding: [0, 2, 0, 0], align: 'center' }, { text: 'i have no padding', padding: [0, 0, 0, 0] });
    ...
    it('handles top/bottom padding', function () {
      ...
      ui.div('i am a string', { text: 'i am a second string', padding: [2, 0, 0, 0] }, { text: 'i am a third string that should be wrapped', padding: [0, 0, 1, 0] });
  ...
  describe('wrap', function () {
    it('allows wordwrap to be disabled', function () {
      ...
      ui.div({ text: 'i am a string', padding: [0, 1, 0, 0] }, { text: 'i am a second string', padding: [0, 2, 0, 0] }, { text: 'i am a third string that should not be wrapped', padding: [0, 0, 0, 2] });
  ...
  describe('span', function () {
    it('appends the next row to the end of the prior row if it fits', function () {
      ...
      ui.span({ text: 'i am a string that will be wrapped', width: 30 });

      ui.div({ text: ' [required] [default: 99]', align: 'right' });
    ...
    it('does not append the string if it does not fit on the prior row', function () {
      ...
      ui.div({ text: 'i am a second row', align: 'left' });
    ...
    it('always appends text to prior span if wrap is disabled', function () {
      ...
      ui.div({ text: 'i am a second row', align: 'left', padding: [0, 0, 0, 3] });
...
//# sourceMappingURL=cliui-compiled.js.map