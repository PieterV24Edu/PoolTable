...
var _typeof5 = typeof Symbol === "function" && _typeof6(Symbol.iterator) === "symbol" ? function (obj) {
  ...
  return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj === "undefined" ? "undefined" : _typeof2(obj);
    ...
    wsize = require("window-size");module.exports = function (yargs) {
  var self = {};var fails = [];self.failFn = function (f) {
    fails.push(f);
  };var failMessage = null;var showHelpOnFail = true;self.showHelpOnFail = function (enabled, message) {
    if (typeof enabled === "string") {
      message = enabled;enabled = true;
    } else if (typeof enabled === "undefined") {
      enabled = true;
    }failMessage = message;showHelpOnFail = enabled;return self;
    ...
    if (fails.length) {
      ...
      if (showHelpOnFail) yargs.showHelp("error");if (msg) console.error(msg);if (failMessage) {
        if (msg) console.error("");console.error(failMessage);
  ...
  };var usage;self.usage = function (msg) {
    usage = msg;
  };var examples = [];self.example = function (cmd, description) {
    examples.push([cmd, description || ""]);
  };var commands = [];self.command = function (cmd, description) {
    commands.push([cmd, description || ""]);
  };self.getCommands = function () {
    return commands;
  };var descriptions = {};self.describe = function (key, desc) {
    ...
    return descriptions;
  };var epilog;self.epilog = function (msg) {
    epilog = msg;
  };var wrap = windowWidth();self.wrap = function (cols) {
    wrap = cols;
  };self.help = function () {
    normalizeAliases();var demanded = yargs.getDemanded(),
      ...
      if (key !== "_") acc[key] = true;return acc;
    }, {})),
        ui = cliui({ width: wrap, wrap: !!wrap });if (usage) {
      var u = usage.replace(/\$0/g, yargs.$0);ui.div(u + "\n");
    }if (commands.length) {
      ui.div("Commands:");commands.forEach(function (command) {
        ui.div({ text: command[0], padding: [0, 2, 0, 2], width: maxWidth(commands) + 4 }, { text: command[1] });
      });ui.div();
    }var aliasKeys = (Object.keys(options.alias) || []).concat(Object.keys(yargs.parsed.newAliases) || []);keys = keys.filter(function (key) {
    ...
    }var description = fn.name ? decamelize(fn.name, "-") : "generated-value";return ["(", description, ")"].join("");
  };function defaultString(value, defaultDescription) {
    var string = "[default: ";if (value === undefined) return null;if (defaultDescription) {
      string += defaultDescription;
    } else {
      switch (typeof value === "undefined" ? "undefined" : _typeof(value)) {case "string":
          string += JSON.stringify(value);break;case "object":
          string += JSON.stringify(value);break;default:
          string += value;}
    }return string + "]";
  }function windowWidth() {
    return wsize.width ? Math.min(80, wsize.width) : null;
  }var version = null;self.version = function (ver, opt, msg) {
    version = ver;
...
//# sourceMappingURL=usage-compiled.min-compiled.min-compiled.min-compiled.min-compiled.min-compiled.js.map